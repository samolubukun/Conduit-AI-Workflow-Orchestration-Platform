<p align="center">
  <picture>
    ...
    <img src="./public/logos/logo-light.svg" alt="Conduit Logo" width="220" />
  </picture>
</p>
...
<table>
  <tr>
    <td align="center" width="120">
      <img src="./public/logos/openai.svg" width="40" height="40" alt="OpenAI" /><br />
      <sub><b>OpenAI</b><br/>GPT-4o & Reasoning</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/anthropic.svg" width="40" height="40" alt="Anthropic" /><br />
      <sub><b>Anthropic</b><br/>Claude 3.5 Sonnet</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/gemini.svg" width="40" height="40" alt="Gemini" /><br />
      <sub><b>Google Gemini</b><br/>1.5 Flash & Pro</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/deepseek.svg" width="40" height="40" alt="DeepSeek" /><br />
      <sub><b>DeepSeek</b><br/>V3 & R1 Models</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/elevenlabs.svg" width="40" height="40" alt="ElevenLabs" /><br />
      <sub><b>ElevenLabs</b><br/>Voice Synthesis</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/deepgram.svg" width="40" height="40" alt="Deepgram" /><br />
      <sub><b>Deepgram</b><br/>Speech-to-Text</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="120">
      <img src="./public/logos/stripe.svg" width="40" height="40" alt="Stripe" /><br />
      <sub><b>Stripe</b><br/>Events & Billing</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/github.svg" width="40" height="40" alt="GitHub" /><br />
      <sub><b>GitHub</b><br/>PRs, Issues, Hooks</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/googleform.svg" width="40" height="40" alt="Google Forms" /><br />
      <sub><b>Google Forms</b><br/>Form Submissions</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/resend.svg" width="40" height="40" alt="Resend" /><br />
      <sub><b>Resend</b><br/>Transactional Email</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/slack.svg" width="40" height="40" alt="Slack" /><br />
      <sub><b>Slack</b><br/>Team Alerts</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/discord.svg" width="40" height="40" alt="Discord" /><br />
      <sub><b>Discord</b><br/>Webhooks & Bots</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="120">
      <img src="./public/logos/telegram.svg" width="40" height="40" alt="Telegram" /><br />
      <sub><b>Telegram</b><br/>Bot Messages</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/twilio.svg" width="40" height="40" alt="Twilio" /><br />
      <sub><b>Twilio</b><br/>SMS & WhatsApp</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/notion.svg" width="40" height="40" alt="Notion" /><br />
      <sub><b>Notion</b><br/>Databases & Pages</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/airtable.svg" width="40" height="40" alt="Airtable" /><br />
      <sub><b>Airtable</b><br/>Base Records</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/linear.svg" width="40" height="40" alt="Linear" /><br />
      <sub><b>Linear</b><br/>Issue Tracking</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/pinecone.svg" width="40" height="40" alt="Pinecone" /><br />
      <sub><b>Pinecone</b><br/>Vector Search</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="120">
      <img src="./public/logos/s3.svg" width="40" height="40" alt="S3" /><br />
      <sub><b>S3 / R2</b><br/>Cloud Object Storage</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/tavily.svg" width="40" height="40" alt="Tavily" /><br />
      <sub><b>Tavily</b><br/>AI Web Search</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/google.svg" width="40" height="40" alt="Google" /><br />
      <sub><b>Google OAuth</b><br/>Authentication</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/logo-symbol.svg" width="40" height="40" alt="Conduit Engine" /><br />
      <sub><b>Custom Webhooks</b><br/>Any HTTP Source</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/logo-symbol.svg" width="40" height="40" alt="Cron" /><br />
      <sub><b>Schedule / Cron</b><br/>Time-based Engine</sub>
    </td>
    <td align="center" width="120">
      <img src="./public/logos/logo-symbol.svg" width="40" height="40" alt="Manual" /><br />
...
```mermaid
graph LR
  User[User Studio Canvas] -->|Save & Execute| TRPC[tRPC Router Layer]
  TRPC -->|Credit Check & Workflow Sync| DB[(PostgreSQL + Drizzle ORM)]
  TRPC -->|Dispatch Event| Inngest[Inngest Event Bus]
  
  subgraph Engine [Durable Execution Engine]
    Inngest --> Step1[1. Prepare & Topo Sort]
    Step1 --> Step2[2. Model 1: Gemini Ingestion]
    Step2 --> Step3[3. Model 2: Claude Reasoning]
    Step3 --> Step4[4. Output: Slack / Webhook]
  end
